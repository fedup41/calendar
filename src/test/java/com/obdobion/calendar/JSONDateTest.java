...
public class JSONDateTest
{
    ...
    {
        final LocalDateTime ldt = CalendarFactory.modify("2013-03-11T01:38:18.309Z");
        Assert.assertEquals(
        ...
        Assert.assertEquals("JSON format", "2013-03-11T01:38:18.309", jsonFormat.substring(0, 23));
    }
}
